        ...
        <div class="grid grid-cols-2 lg:grid-cols-3 gap-3 mb-3">
            <template v-for="attachment of post.attachments">
                <div
                    ...
                    <!-- download -->
                    <button
                        class="opacity-0 group-hover:opacity-100 transition-all w-8 h-8 flex items-center justify-center bg-gray-800 text-gray-100 rounded absolute right-2 top-2 hover:bg-gray-900">
