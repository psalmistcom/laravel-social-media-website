...
<template>
    <div class="p-4 bg-white rounded-lg border mb-3">
        <div @click="postCreating = true" class="py-3 px-2 text-gray-400 border border-2 border-gray-200 rounded">
    ...
    <div v-if="postCreating" class="flex gap-2 justify-between">
        <button type="submit"
            ...
            Attach Files
            <input type="file" class="absolute left-0 top0 right-0 bottom-0 opacity-0">
        </button>
        <button type="submit"
